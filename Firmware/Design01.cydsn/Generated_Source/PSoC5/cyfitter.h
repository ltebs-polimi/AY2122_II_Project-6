...
/* Pin_ROSSO */
#define Pin_ROSSO__0__INTTYPE CYREG_PICU2_INTTYPE2
#define Pin_ROSSO__0__MASK 0x04u
#define Pin_ROSSO__0__PC CYREG_PRT2_PC2
#define Pin_ROSSO__0__PORT 2u
#define Pin_ROSSO__0__SHIFT 2u
#define Pin_ROSSO__AG CYREG_PRT2_AG
#define Pin_ROSSO__AMUX CYREG_PRT2_AMUX
#define Pin_ROSSO__BIE CYREG_PRT2_BIE
#define Pin_ROSSO__BIT_MASK CYREG_PRT2_BIT_MASK
#define Pin_ROSSO__BYP CYREG_PRT2_BYP
#define Pin_ROSSO__CTL CYREG_PRT2_CTL
#define Pin_ROSSO__DM0 CYREG_PRT2_DM0
#define Pin_ROSSO__DM1 CYREG_PRT2_DM1
#define Pin_ROSSO__DM2 CYREG_PRT2_DM2
#define Pin_ROSSO__DR CYREG_PRT2_DR
#define Pin_ROSSO__INP_DIS CYREG_PRT2_INP_DIS
#define Pin_ROSSO__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU2_BASE
#define Pin_ROSSO__LCD_COM_SEG CYREG_PRT2_LCD_COM_SEG
#define Pin_ROSSO__LCD_EN CYREG_PRT2_LCD_EN
#define Pin_ROSSO__MASK 0x04u
#define Pin_ROSSO__PORT 2u
#define Pin_ROSSO__PRT CYREG_PRT2_PRT
#define Pin_ROSSO__PRTDSI__CAPS_SEL CYREG_PRT2_CAPS_SEL
#define Pin_ROSSO__PRTDSI__DBL_SYNC_IN CYREG_PRT2_DBL_SYNC_IN
#define Pin_ROSSO__PRTDSI__OE_SEL0 CYREG_PRT2_OE_SEL0
#define Pin_ROSSO__PRTDSI__OE_SEL1 CYREG_PRT2_OE_SEL1
#define Pin_ROSSO__PRTDSI__OUT_SEL0 CYREG_PRT2_OUT_SEL0
#define Pin_ROSSO__PRTDSI__OUT_SEL1 CYREG_PRT2_OUT_SEL1
#define Pin_ROSSO__PRTDSI__SYNC_OUT CYREG_PRT2_SYNC_OUT
#define Pin_ROSSO__PS CYREG_PRT2_PS
#define Pin_ROSSO__SHIFT 2u
#define Pin_ROSSO__SLW CYREG_PRT2_SLW
...
/* LED_Status */
#define LED_Status__0__INTTYPE CYREG_PICU2_INTTYPE1
#define LED_Status__0__MASK 0x02u
#define LED_Status__0__PC CYREG_PRT2_PC1
#define LED_Status__0__PORT 2u
#define LED_Status__0__SHIFT 1u
#define LED_Status__AG CYREG_PRT2_AG
#define LED_Status__AMUX CYREG_PRT2_AMUX
#define LED_Status__BIE CYREG_PRT2_BIE
#define LED_Status__BIT_MASK CYREG_PRT2_BIT_MASK
#define LED_Status__BYP CYREG_PRT2_BYP
#define LED_Status__CTL CYREG_PRT2_CTL
#define LED_Status__DM0 CYREG_PRT2_DM0
#define LED_Status__DM1 CYREG_PRT2_DM1
#define LED_Status__DM2 CYREG_PRT2_DM2
#define LED_Status__DR CYREG_PRT2_DR
#define LED_Status__INP_DIS CYREG_PRT2_INP_DIS
#define LED_Status__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU2_BASE
#define LED_Status__LCD_COM_SEG CYREG_PRT2_LCD_COM_SEG
#define LED_Status__LCD_EN CYREG_PRT2_LCD_EN
#define LED_Status__MASK 0x02u
#define LED_Status__PORT 2u
#define LED_Status__PRT CYREG_PRT2_PRT
#define LED_Status__PRTDSI__CAPS_SEL CYREG_PRT2_CAPS_SEL
#define LED_Status__PRTDSI__DBL_SYNC_IN CYREG_PRT2_DBL_SYNC_IN
#define LED_Status__PRTDSI__OE_SEL0 CYREG_PRT2_OE_SEL0
#define LED_Status__PRTDSI__OE_SEL1 CYREG_PRT2_OE_SEL1
#define LED_Status__PRTDSI__OUT_SEL0 CYREG_PRT2_OUT_SEL0
#define LED_Status__PRTDSI__OUT_SEL1 CYREG_PRT2_OUT_SEL1
#define LED_Status__PRTDSI__SYNC_OUT CYREG_PRT2_SYNC_OUT
#define LED_Status__PS CYREG_PRT2_PS
#define LED_Status__SHIFT 1u
#define LED_Status__SLW CYREG_PRT2_SLW
